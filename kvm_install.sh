...
clear
echo -e "[${GREEN}SUCCESS${TEXTRESET}] Rocky KVMBuilder ${YELLOW}Installation${TEXTRESET}"
...
AFTER YOU SET THESE OPTIONS THE INTERFACES WILL RESET AND THE SERVER WILL REBOOT" 30 80
}
